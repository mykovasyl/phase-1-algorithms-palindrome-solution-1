...
describe("isPalindrome", () => {
  ...
  it("returns false for 'abrarba'", () => {
    expect(isPalindrome("abrarba")).to.be.true;
  });
  it("returns false for 'bottle'", () => {
    expect(isPalindrome("angela")).to.be.false;
  });
  it("returns false for 'bottle'", () => {
    expect(isPalindrome("bottle")).to.be.false;
  });
});
